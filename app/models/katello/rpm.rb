module Katello
  class Rpm < Katello::Model
    ...
    PULP_INDEXED_FIELDS = %w(name version release arch epoch sourcerpm checksum filename _id)
    CONTENT_TYPE = "rpm"
    ...
    def update_from_json(json)
      keys = %w(name version release arch epoch filename sourcerpm checksum summary)
